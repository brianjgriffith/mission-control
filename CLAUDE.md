...
| 4 | `004_product_groups.sql` | Adds `group_name` to products table, assigns product families (VRA, Accelerator, Elite, etc.), updates RPC functions to aggregate by group. | PENDING | 003 | 2026-03-21 |
