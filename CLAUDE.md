...
| 12 | `012_student_archive.sql` | Adds `archived` boolean and `archived_at` timestamp to students table with index. Enables hiding students from roster without deleting them. | PENDING | 001 | 2026-04-15 |
